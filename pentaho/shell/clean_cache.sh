...
PARAMS2="-param:SCHEMA_EPM=EPM_MSG -param:PATH=$PATH_FILES  -param:KTR-CLEAN-CACHE=CLEAN_CACHE.ktr" 
echo "Inicio proceso limpieza cache `date`" >> $DIRLOG/Process_CleanCache.log
$DIRBINPTHO/kitchen.sh -file=$DIRJOB_GENERAR_SCORE/CLEAN-CACHE.kjb $PARAMS2 -Level:Rowlevel >> $DIRLOG/Process_CleanCache.log
